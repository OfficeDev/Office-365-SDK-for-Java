 ...
 */
public class OAuth2PermissionGrantCollectionOperations extends OrcOperations{
     ...
     */
    public OAuth2PermissionGrantCollectionOperations(String urlComponent, OrcExecutable parent) {
